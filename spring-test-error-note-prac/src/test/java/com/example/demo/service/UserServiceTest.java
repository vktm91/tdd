...
public class UserServiceTest {
    ...
    @MockBean   // 스프링에 있는 javaMailSender라는 Bean 객체를 Mock으로 선언된 객체로 덮어쓰기하는 것임. 이러면 테스트 실행할 때 MockBean 값이 주입돼서 실행된다.
...
//        assertThat(result.getCertificationCode()).isEqualTo("현재는랜덤값테스트할방법이없음");
    }
